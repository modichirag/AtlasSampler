...
from atlassampler import HMC_AdaptiveStepsize
import logging
...
# Save folder
if args.combine_chains: folder = 'nodr_stepadapt'
else: folder = 'nodr_stepadapt-indep'
...
kernel = HMC_AdaptiveStepsize(D, lp, lp_g, 
