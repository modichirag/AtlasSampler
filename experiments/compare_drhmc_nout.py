...
from atlassampler import DRHMC_NoUT
...
parser.add_argument('--step_factor', type=float, default=5, help='stepsize factor over nuts')
...
#####################
# Atlas
if args.combine_chains: folder = 'drhmc_nout'
else: folder = 'drhmc_nout-indep'
savefolder = f"{savepath}/{folder}/sfac{args.step_factor}/"
